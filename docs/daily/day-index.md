...
| 17 | Anti-cheating and regression tests | PLANNED |
| 18 | Failure memory and verified knowledge | PLANNED |
| 19 | CLI commands and run inspection | PLANNED |
| 20 | Configuration and error handling | PLANNED |
| 21 | Security review and safety tests | PLANNED |
| 22 | Documentation and example experiment | PLANNED |
| 23 | Clean-install reproduction | PLANNED |
| 24 | v0.1 release candidate | PLANNED |
| 25–35 | Strategy evolution research | PLANNED |
| 36+ | Future extensions after v0.1 | DEFERRED |

The index is a roadmap, not permission to skip acceptance criteria.
